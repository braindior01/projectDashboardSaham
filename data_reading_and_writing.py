...
conn = sqlite3.connect('data/tmp2.db', check_same_thread=False)
...
def read_table(target_index=None, target_keywords=None):
    query = f"SELECT Buy.EmitenBuy, Buy.BuyVal, Sell.SellVal FROM Buy INNER JOIN Sell ON Buy.EmitenBuy = Sell.EmitenSell WHERE Buy.unix_date = '2024-01-17' AND Sell.unix_date = '2024-01-17'"
